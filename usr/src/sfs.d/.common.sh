...
# gnome
: ${gnome_pkgs:=eog file-roller vinagre ibus-clutter nautilus-share libpam-gnome-keyring gstreamer1.0-libav network-manager-vpnc-gnome libgnomevfs2-0 gnome-online-accounts gnome-session-flashback network-manager-gnome network-manager-openvpn-gnome network-manager-openconnect-gnome gnome-shell-extensions gnome-tweak-tool gnome-shell-timer gnome-screenshot gnome-system-monitor ssh-askpass-gnome gnome-disk-utility gnome-nettool network-manager-iodine-gnome gnome-power-manager network-manager-pptp-gnome gstreamer1.0-tools gstreamer1.0-plugins-ugly gvfs-backends gvfs-fuse gvfs-bin telepathy-idle telepathy-salut telepathy-gabble seahorse baobab gkbd-capplet gnome-terminal gdm3 gnome-control-center brasero cheese colord evince empathy gucharmap polari transmission totem-plugins gnome-themes-standard gnome-bluetooth gnome-clocks }

# programs depending on X11 libraries etc.
: ${guilib_based:=libqtwebkit4 libqt5x11extras5 gphoto2 wireshark tcpflow x11vnc virt-viewer avahi-discover qemu-kvm zenmap dsniff guymager xvfb ecryptfs-utils wkhtmltopdf mutt ht pcsc-tools consolekit poppler-utils poppler-data sqsh imagemagick gitk git-gui meld dosbox zim rdesktop unison-gtk gtkterm ddd gparted virtualbricks }

# other gui
: ${gui_pkgs:=$gnome_pkgs $guilib_based libgtk2.0-bin python-gconf pavucontrol im-config vim-gtk nvidia-installer-cleanup sound-theme-freedesktop ttf-unifont gedit-plugins ibus-gtk twm xclip gksu ibus-input-pad gnome-calculator software-properties-common xfonts-unifont ibus-wayland xfonts-terminus xserver-xorg-input-wacom xserver-xephyr xserver-xorg-video-qxl xserver-xorg-input-joystick gir1.2-webkit-3.0 synaptic ibus-gtk3 xvnc4viewer terminator libfreerdp-plugins-standard mousetweaks libcanberra-gtk-module xpad pulseaudio-module-bluetooth blueman xzoom xinput mesa-utils task-desktop xterm ghex smart-notifier conky xbacklight keepassx glx-alternative-nvidia gtk2-engines-pixbuf }
